...
def train_and_evaluate():
    ...
    target = 'power_kw'
    drop_cols = ['datetime', 'power_kw', 'active_chargers'] # On enlève la cible et les infos "futures" ou métadonnées
    
    # Vérification que toutes les colonnes sont numériques
    features_to_remove = ['lag_15m', 'lag_1h', 'rolling_mean_4h', 'lag_24h', 'lag_1week', 'avg_energy_yesterday']
