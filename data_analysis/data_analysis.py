...
fig_ts = px.line(df_filtered, x='datetime', y='power_kw', title='Puissance consommée au cours du temps')
...
fig_profile = px.bar(hourly_profile, x='hour', y='power_kw', 
...
st.write("Zoom sur les 7 premiers jours de la sélection (pour voir les cycles Jour/Nuit) :")
st.plotly_chart(px.line(df_filtered.head(24*4*7), x='datetime', y='power_kw'), use_container_width=True)